...
exports.SurveyConfigModule = SurveyConfigModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([survey_entity_1.Survey, questionGroup_entity_1.QuestionGroup, question_entity_1.Question, option_entity_1.Option, question_model_entity_1.QuestionModel, answer_entity_1.Answer, subSubItemAnswer_entity_1.SubSubItemAnswer])],
