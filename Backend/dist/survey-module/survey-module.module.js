...
const survey_module_controller_1 = require("../survey-module/survey-module.controller");
const survey_module_service_1 = require("../survey-module/survey-module.service");
const typeorm_1 = require("@nestjs/typeorm");
const modules_entity_1 = require("./survey-module.entity/modules.entity");
const app_entity_1 = require("../survey-module/survey-module.entity/app.entity");
const menu_entity_1 = require("../survey-module/survey-module.entity/menu.entity");
