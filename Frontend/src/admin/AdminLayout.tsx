...
const navItems = [
  ...
  { label: 'Fd Grp', path: '/admin/field', icon: <ListTree size={18} /> },
  {
    label: "Field", 
    path: "/admin/datapoint",
    icon: <ListTree size={18} />,
  },
  { label: 'Fd Grp - Field Map', path: '/admin/datapointmap', icon: <ListTree size={18} /> },
  ...
  { label: 'Page - Fd Grp Map', path: '/admin/dpgroupmap', icon: <ListPlus size={18} /> },
