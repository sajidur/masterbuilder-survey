...
const navItems = [
  ...
  { label: 'Category', path: '/admin/app', icon: <AppWindow size={18} /> },
  { label: 'App', path: '/admin/menu', icon: <List size={18} /> },
  { label: 'Aggregate', path: '/admin/item', icon: <Layers size={18} /> },
  { label: 'FG', path: '/admin/field', icon: <ListTree size={18} /> },
  {
    label: "Field", 
  ...
  { label: 'Page - FG Map', path: '/admin/dpgroupmap', icon: <ListPlus size={18} /> },
  { label: 'Reports', path: '/admin/reports', icon: <BarChart4 size={18} /> },
  { label: 'Button', path: '/admin/button', icon: <MdSmartButton size={18} /> },
  { label: 'Page - Button Map', path: '/admin/dpbuttonmap', icon: <ListPlus size={18} /> },
